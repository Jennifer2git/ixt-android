...
public class GlowingText {
    ...
    private int glowColor = 0xFFffffff, // ffffff defines hexadecimal value of
    // color
    glowSpeed;

    private boolean isDirectionUp = true; // Whether radius should increase or
    // Decrease.
    ...
    public GlowingText(Activity mActivity, Context context, View v, float minRadius, float maxRadius, float startRadius, int color, int speed) {
        ...
        if (!(view instanceof IPTTextView) && !(view instanceof Button)) {
    ...
    private void startGlowing() {
        ...
        r = new Runnable() {
            public void run() {
                ...
                if (view instanceof IPTTextView) {
                    ((IPTTextView) view).setShadowLayer(currentGlowRadius, dx, dy, glowColor);
                } else if (view instanceof Button) {
                    ((Button) view).setShadowLayer(currentGlowRadius, dx, dy, glowColor);
                }

            /*
             * currentGlowRadius - Glow radius. dx - Spread of Shadow in X
             * direction dy - Spread of Shadow in Y direction color - Color used
             * to create Glow (White in our case )
             */
               ...
               /* Decrease Glow Radius by 1 */
                  ...
                  /* Minimum has not reached yet. Keep Decreasing */
                        ...
                        System.out.println("Decrease currentGlowRadius :->" + currentGlowRadius);
                   ...
                   */
                        ...
                        System.out.println("currentGlowRadius :->" + currentGlowRadius);
                        System.out.println("dx :->" + dx);
                        System.out.println("dy :->" + dy);
