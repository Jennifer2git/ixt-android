package com.imax.ipt.ui.activity.input.gdc;
...
public class GdcActivity extends InputActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_gdc);
...
//        this.mGridLayout = (GridLayout) findViewById(R.id.gridLayout);
        ...
        this.setupView(mInputController.getInputs(DeviceKind.Gdc));
...
//    public static void fire(Context mContext) {
    public static void fire(Context context, String guid, String title, int inputId) {
        ...
        Intent intent = new Intent(context, GdcActivity.class);
...
//        });
    ...
    private void showDialogZoom() {
        ...
        DialogZoomFragment mDialogZoomFragment = DialogZoomFragment.newInstance
                (mInputController.getInputs(DeviceKind.Gdc).get(0).getId());
