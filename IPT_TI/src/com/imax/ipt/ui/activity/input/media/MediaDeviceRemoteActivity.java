...
public class MediaDeviceRemoteActivity extends MediaRemote implements OnClickListener {
...
//      this.mBtnPlayPause.setOnClickListener(this);
        ...
        findViewById(R.id.btnBack).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                MediaDeviceActivity.fire(MediaDeviceRemoteActivity.this);
            }
        });
    ...
    public static void fire(Context context, String guid, String title, int inputId) {
        Intent intent = new Intent(context, MediaDeviceRemoteActivity.class);
