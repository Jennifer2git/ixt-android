...
import com.imax.ipt.controller.eventbus.handler.movie.GetMovieLiteDirectorsHandler;
...
public class DialogMovieDirectorsFragment extends DialogFragment implements OnItemClickListener {
    public static String DIRECTOR_ID = "actor_id";
    public static String DIRECTOR_NAME = "actor_name";
    ...
    public View onCreateView(LayoutInflater mInflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lp.width = 1618;
        lp.height = 1300;// three row of movie
//        lp.x = 200;
//        lp.y = -180;
//        d.getWindow().setBackgroundDrawable(new ColorDrawable(0));
    ...
    private void init(View view) {
        ...
        guid = bundle.getString(DIRECTOR_ID);
        String title = bundle.getString(DIRECTOR_NAME);
...
//        this.mGridAdapter = new GridAdapter(getActivity().getApplicationContext(), R.layout.item_movie_library, mMoviesActors, R.drawable.ipt_gui_asset_new_movie_icon, 115, 175, 5, 0);
        this.mGridAdapter = new GridAdapter(getActivity().getApplicationContext(), R.layout.item_movie_library, mMoviesActors, R.drawable.catalogue_noposter_bg, 115, 175, 5, 0);
    ...
    private void getMovieLite() {
        ...
        GetMovieLiteDirectorsHandler getMovieLiteEvent = new GetMovieLiteDirectorsHandler();
        getMovieLiteEvent.setStartIndex(0);
        getMovieLiteEvent.setCount(1000);
        getMovieLiteEvent.setDirectorId(guid);
        this.mEventBus.post(getMovieLiteEvent.getRequest());
    }

    public void onEvent(GetMovieLiteDirectorsHandler getMovieLiteEvent) {
