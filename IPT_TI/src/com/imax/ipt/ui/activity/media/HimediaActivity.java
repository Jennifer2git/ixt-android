...
public class HimediaActivity extends MediaRemote implements OnClickListener {
    ...
    private static final String TAG = "OppoRemoteFullActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himedia);
...
//        this.mSeekBarVolumen = (VerticalSeekBar) findViewById(R.id.seekBarVolume);
        ...
        this.volupButton = (ImageButton) findViewById(R.id.volumeUp);
        this.voldownButton = (ImageButton) findViewById(R.id.volumeDown);
...
//        this.mBtnPreviousMenu = (ImageButton) findViewById(R.id.btnPreviousMenu);
        ...
        this.mBtnRootMenu.setVisibility(View.GONE);
...
//        this.mBtnRew.setVisibility(View.GONE);
...
//        this.mBtnPause.setOnClickListener(this);
    ...
    public static void fire(Context context, String guid, String title, int inputId) {
        Intent intent = new Intent(context, HimediaActivity.class);
