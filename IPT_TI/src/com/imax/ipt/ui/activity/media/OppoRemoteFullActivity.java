...
public class OppoRemoteFullActivity extends MediaRemote implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oppo_remote_full1);
...
//        this.txtOk.setOnClickListener(this);
    ...
    public static void fire(Context context, String guid, String title, int inputId) {
        Intent intent = new Intent(context, OppoRemoteFullActivity.class);
