...
/**
 * Created by yanli on 2015/11/20.
 */
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 三角形的最大宽度
     */
    private final int DIMENSION_TRIANGEL_WIDTH = (int) (getScreenWidth()/2 / 3 * RADIO_TRIANGEL);
     ...
     * 标题选中时的颜色
     */
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xf0bf59;//0xFFFFFFFF;
...
//				// 滚动
            ...
            public void onPageScrollStateChanged(int state)
            {
                Log.d("Jennifer","onPageScrollStateChanged");
                // 回调
                if (onPageChangeListener != null)
                {
...
//                ((TextView) view).getPaint().setFlags(Paint.);
    ...
    private TextView generateTextView(String text)
    {
        ...
        lp.width = getScreenWidth()/2 / mTabVisibleCount;
    ...
    public void scroll(int position, float offset)
    {
        ...
        int tabWidth = getScreenWidth() /2/ mTabVisibleCount;
