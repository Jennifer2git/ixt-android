...
public class GridAdapter extends ArrayAdapter<Media> implements SectionIndexer {
...
//   private ViewHolder loadingViewHolder = null;
    ...
    public GridAdapter(Context context, int resource, ArrayList<Media> mMediaList, int defaultLogo, int imageWidth, int imageHeight, int imagePadding, int mEmptyElements) {
//    public GridAdapter( int resource, ArrayList<Media> mMediaList, int defaultLogo, int imageWidth, int imageHeight, int imagePadding, int mEmptyElements) {
...
//            RelativeLayout layoutMedia = (RelativeLayout) view.findViewById(R.id.layout);
            BetterImageView imageMovieIcon = (BetterImageView) view.findViewById(R.id.imgMovieIcon);
            ...
            viewHolder.imgMovieIcon = imageMovieIcon;
...
//        RelativeLayout layout = holder.layoutMedia;
        ...
        ImageView imageViewMovieIcon = holder.imgMovieIcon;
//        layout.setVisibility(View.VISIBLE);
        imageView.setVisibility(View.VISIBLE);
        imageViewMovieIcon.setVisibility(View.VISIBLE);
        ...
        if (media.getCoverArtPath().length() > 0) {
            ...
            if(media.getCoverArtPath() != null){
                imageViewMovieIcon.setVisibility(View.INVISIBLE);
            }
        }
...
//         loadingViewHolder = holder;
            ...
            //if (ismViewShowMediaLoadingProgress())
            {
                ...
                CircularSeekBar mCircularSeekbar = (CircularSeekBar) layoutProgress.findViewById(R.id.progressSeekBar);// this  is for movie progress
