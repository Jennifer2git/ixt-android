 ...
 *
 */
package com.imax.ipt.ui.widget.circularseekbar;
...
public class CircularSeekBar extends View {
    ...
    public CircularSeekBar(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        setProgressColor(getResources().getColor(R.color.electric_blue));
        setProgressBackgroundColor(getResources().getColor(R.color.glass_line));
        setProgress(0.0f);
