...
public class BetterImageView extends ImageView {
    ...
    public void invalidateDrawable(Drawable dr) {
        ...
        //if (DEBUG)
        //Log.i(TAG, "invalidateDrawable: " + dr + " current drawable: " + currentDrawable);
        if (dr == currentDrawable) {
         /*
          * we invalidate the whole view in this case because it's very hard to
          * know where the drawable actually is. This is made complicated
          * because of the offsets and transformations that can be applied. In
          * theory we could get the drawable's bounds and run them through the
          * transformation and offsets, but this is probably not worth the
          * effort.
          */
