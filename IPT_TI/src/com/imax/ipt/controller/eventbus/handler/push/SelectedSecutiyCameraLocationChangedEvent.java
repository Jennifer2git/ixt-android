...
public class SelectedSecutiyCameraLocationChangedEvent extends PushHandler {

    public static final String TAG = "SelectedSecutiyCameraLocationChangedEvent";
