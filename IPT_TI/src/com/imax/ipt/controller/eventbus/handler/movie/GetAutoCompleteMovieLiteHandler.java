...
public class GetAutoCompleteMovieLiteHandler extends Handler {
    public static final String TAG = "GetAutoCompleteMovieLiteHandler";
    ...
    public Request getRequest() {
        return new Request(GET_MOVIES_LITE_AUTOCOMPLETE, METHOD_NAME, getParameters(), this);
    }
