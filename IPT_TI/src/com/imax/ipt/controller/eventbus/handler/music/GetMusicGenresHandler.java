...
public class GetMusicGenresHandler extends Handler {
    public static final String TAG = "GetMusicGenresHandler";

    private Genre[] genres;

    public static final String METHOD_NAME = "getMusicGenres";
