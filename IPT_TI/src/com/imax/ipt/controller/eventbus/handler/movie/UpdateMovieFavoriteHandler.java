...
public class UpdateMovieFavoriteHandler extends Handler {

    public static String TAG = "UpdateMovieHandler";
    private static final String METHOD_NAME = "updateMovieFavorite";

    private Movie mMovie = new Movie();

    public UpdateMovieFavoriteHandler(Movie mMovie) {
        super();
        this.mMovie = mMovie;
    }
...
//      list.add(getMovie());
    ...
    public Request getRequest() {
        return new Request(UPDATE_MOVIE_FAVORITE, METHOD_NAME, getParameters(), this);
    }
